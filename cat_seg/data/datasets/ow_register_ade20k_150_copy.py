...
def _register_ade20k_150_semantic_segmentation(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation"), ("test", "validation")]:
        ...
        MetadataCatalog.get(name_ow).set(
            # stuff_classes=meta["stuff_classes"],
            # stuff_dataset_id_to_contiguous_id=meta["stuff_dataset_id_to_contiguous_id"],
            evaluator_type="_ow_sem_seg",  # Use Open-World evaluator
            ignore_label=255,
            **meta,
        )
...
_register_ade20k_150_semantic_segmentation(_root)